...
class DataManager:
    ...
    def __init__(self):
        ...
        self.lstDataTypes.append(C2DataType(nTTL=1*60*1000/nFactor, nPeriodSec=60/nFactor, nType=2, nSize=20*1024, sRatioMaxReceivers=1.0))   # INTEREST 2
        ################################################
        # Operational data
        self.lstDataTypes.append(C2DataType(nTTL=2*60*1000/nFactor,  nPeriodSec=2*60/nFactor,  nType=3, nSize=50*1024, sRatioMaxReceivers=1.0))   # INTEREST 3
        self.lstDataTypes.append(C2DataType(nTTL=5*60*1000/nFactor,  nPeriodSec=5*60/nFactor,  nType=4, nSize=100*1024, sRatioMaxReceivers=1.0))   # INTEREST 4
        self.lstDataTypes.append(C2DataType(nTTL=10*60*1000/nFactor, nPeriodSec=10*60/nFactor, nType=5, nSize=200*1024, sRatioMaxReceivers=1.0))   # INTEREST 5
        self.lstDataTypes.append(C2DataType(nTTL=20*60*1000/nFactor, nPeriodSec=10*60/nFactor, nType=6, nSize=500*1024, sRatioMaxReceivers=1.0))   # INTEREST 6
