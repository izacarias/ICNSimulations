...
class DataManager:
    ...
    def __init__(self):
        ...
        self.lstDataTypes.append(C2DataType(nTTL=1*60*1000/nFactor, nPeriodSec=60/nFactor, nType=2, nSize=1024, sRatioMaxReceivers=0.2))   # INTEREST 2
        ################################################
        # Operational data
        ...
        self.lstDataTypes.append(C2DataType(nTTL=20*60*1000/nFactor, nPeriodSec=20*60/nFactor, nType=6, nSize=10*1024*1024, sRatioMaxReceivers=0.4))   # INTEREST 6
